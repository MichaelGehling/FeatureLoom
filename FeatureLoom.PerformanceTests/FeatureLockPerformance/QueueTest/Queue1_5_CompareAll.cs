...
namespace FeatureLoom.PerformanceTests.FeatureLockPerformance.QueueTest
{
    ...
    public class Queue1_5_CompareAll
    {
        ...
        public void FeatureLock_LockPrioProd() => queueTest.Run(featureLockSubjects.LockPrio, featureLockSubjects.Lock);
        ...
        [Benchmark]
        public void MicroSpinLock_LockPrioProd() => queueTest.Run(microSpinLockSubjects.LockPrio, microSpinLockSubjects.Lock);
        //[Benchmark]
...
/*
        ...
        */
        ...
        [Benchmark]
        public void FeatureLock_LockAsyncPrioProd_() => queueTest.AsyncRun(featureLockSubjects.LockPrioAsync, featureLockSubjects.LockAsync);
