...
- Ask if information is missing and cannot easily be found.

## Working rules
- For extensive complex tasks prepare a plan first (.md file)
- Read before editing; make minimal, targeted changes.
- Build to verify. Run the test suite for behavior changes.
...
## Topic instructions
Detailed rules live in `.github/instructions/` and load automatically by file scope:
