...
{
    public class JsonSerializerCollectionTests
    {
        ...
        public void Serialize_IReadOnlyList()
        {
            ...
            AssertSerialized(value, expected, new JsonSerializer.Settings { typeInfoHandling = JsonSerializer.TypeInfoHandling.AddNoTypeInfo });
        }
        ...
        public void Serialize_ByteArray_AsBase64()
        {
            ...
            AssertSerialized(value, expected, new JsonSerializer.Settings { writeByteArrayAsBase64String = true });
        }
        ...
        public void Serialize_ByteArray_AsArray()
        {
            ...
            AssertSerialized(value, expected, new JsonSerializer.Settings { writeByteArrayAsBase64String = false });
        }
        ...
        public void Serialize_TreatEnumerablesAsCollections_False_SerializesAsObject()
        {
            ...
            AssertSerialized(value, expected, new JsonSerializer.Settings { treatEnumerablesAsCollections = false });
        }
