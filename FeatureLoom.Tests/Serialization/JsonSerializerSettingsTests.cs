...
namespace FeatureLoom.Serialization
{
    public class JsonSerializerSettingsTests
    {
        ...
        public void Serialize_Indentation_Object_DefaultFactor()
        {
            ...
            var settings = new JsonSerializer.Settings { indent = true, indentationFactor = 2 };
        ...
        {
            var value = new IndentSample();
            var settings = new JsonSerializer.Settings { indent = true, indentationFactor = 4 };
            const string expected = "{\n    \"A\":1,\n    \"B\":\"x\"\n}";
        ...
        public void Serialize_Indentation_MaxDepth_LimitsIndentation()
        {
            ...
            var settings = new JsonSerializer.Settings { indent = true, indentationFactor = 2, maxIndentationDepth = 1 };
            const string expected = "{\n  \"A\":1,\n  \"Inner\":{\n  \"B\":2,\n  \"Inner\":{\n  \"C\":3\n  }\n  }\n}";
        ...
        public void Serialize_SmallTempBufferSize_LongDictionaryKey()
        {
            ...
            var settings = new JsonSerializer.Settings { tempBufferSize = 8 };
