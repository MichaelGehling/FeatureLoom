...
{
    public class FeatureJsonSerializerPrimitiveTests
    {
        ...
        {
            AssertSerialized(value, expected, new FeatureJsonSerializer.Settings { enumAsString = false });
        }
        ...
        {
            AssertSerialized(value, expected, new FeatureJsonSerializer.Settings { enumAsString = true });
        }
