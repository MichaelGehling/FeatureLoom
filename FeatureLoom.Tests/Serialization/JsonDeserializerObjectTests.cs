...
{
    public class JsonDeserializerObjectTests
    {
        ...
        private static object Deserialize(string json, JsonDeserializer.Settings settings)
        {
        ...
        private static T DeserializeTyped<T>(string json, JsonDeserializer.Settings settings)
        {
            var deserializer = new JsonDeserializer(settings);
            Assert.True(deserializer.TryDeserialize(json, out T value));
            return value;
