...
{
    public class FeatureJsonSerializerReferenceTests
    {
        ...
        public void Serialize_ReferenceCheck_OnLoopReplaceByNull()
        {
            ...
            AssertSerialized(root, expected, new FeatureJsonSerializer.Settings
            {
                referenceCheck = FeatureJsonSerializer.ReferenceCheck.OnLoopReplaceByNull
            });
        }
        ...
        public void Serialize_ReferenceCheck_OnLoopReplaceByRef()
        {
            ...
            AssertSerialized(root, expected, new FeatureJsonSerializer.Settings
            {
                referenceCheck = FeatureJsonSerializer.ReferenceCheck.OnLoopReplaceByRef
            });
        }
        ...
        public void Serialize_ReferenceCheck_OnLoopThrowException()
        {
            ...
            {
                var serializer = new FeatureJsonSerializer(new FeatureJsonSerializer.Settings
                {
                    referenceCheck = FeatureJsonSerializer.ReferenceCheck.OnLoopThrowException
                });
