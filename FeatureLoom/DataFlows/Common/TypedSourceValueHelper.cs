...
namespace FeatureLoom.DataFlows
{
    ...
    public struct TypedSourceValueHelper<T>
    {
        ...
        {
            if (sink == null) return;
            if (sink is ITypedDataFlowSink typedSink && !typedSink.ConsumedMessageType.IsAssignableFrom(typeof(T))) throw new Exception("It is not allowed to connect a TypedDataFlowSource to a TypedDataFlowSink if the type of the source cannot be assigned to the sink type!");
